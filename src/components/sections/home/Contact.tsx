...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Freelance Finances?',
  mainDescription:
    'Our team of financial experts is here to help you streamline your invoicing and accounting. Get personalized support for your freelance business.',
  formTitle: 'Contact Our Team',
  formDescription:
    "Tell us about your freelance business needs and we'll get back to you within 4 hours.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Quick Support',
  method1Title: 'Email Support',
  method1Description: 'Get detailed help via email',
  method1Contact: 'support@freelancefinancials.com',
  ...
  office1City: 'Austin',
  office1Address: '1234 Freelancer Way, Suite 200',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Portland',
  office2Address: '567 Creative Street, Floor 8',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Miami',
  office3Address: '890 Business Blvd, Building C',
  ...
  supportNote: 'Priority support included with Professional and Business plans',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Sarah Johnson',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'sarah@freelancer.com',
  companyLabel: 'Business Name (Optional)',
  companyPlaceholder: 'Your Freelance Business',
  messageLabel: 'How can we help? *',
  messagePlaceholder: 'I need help setting up automated invoicing for my design clients...',
} as const;
