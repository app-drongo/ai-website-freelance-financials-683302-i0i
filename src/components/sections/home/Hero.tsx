...
const DEFAULT_HERO = {
  ...
  title: 'Simplify your freelance finances with',
  titleHighlight: 'Freelance Financials',
  description:
    'The all-in-one invoicing and accounting platform designed specifically for freelancers. Create professional invoices, track expenses, and manage your finances effortlessly.',
  features: [
  ...
  imageAlt: 'Freelance Financials dashboard showing invoice management',
  statsLabel1: 'Invoice Creation',
  statsValue1: 'Under 2 min',
  statsLabel2: 'Payment Speed',
  statsValue2: '3x faster',
} as const;
