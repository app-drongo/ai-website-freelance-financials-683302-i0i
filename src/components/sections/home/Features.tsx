...
const DEFAULT_FEATURES = {
  badge: 'Core Features',
  mainTitle: 'Everything Freelancers Need',
  mainTitleHighlight: 'All in One Platform',
  mainDescription:
    'Streamline your freelance business with professional invoicing, expense tracking, and financial insights designed specifically for independent professionals.',
  feature1Title: 'Smart Invoice Generation',
  feature1Description:
    'Create professional invoices in seconds with customizable templates, automatic calculations, and instant PDF delivery to clients.',
  feature1Badge: 'Invoicing',
  feature2Title: 'Bank-Level Security',
  feature2Description:
    'Your financial data is protected with 256-bit encryption, secure cloud storage, and compliance with industry standards.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Invoice Management',
  feature3Description:
    'Send invoices, track payments, and manage expenses on-the-go with our native mobile app for iOS and Android.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Currency Support',
  feature4Description:
    'Work with international clients seamlessly with support for 150+ currencies and automatic exchange rate updates.',
  feature4Badge: 'Global',
  feature5Title: 'Financial Insights & Reports',
  feature5Description:
    'Track your income, expenses, and profitability with detailed reports and visual dashboards for better business decisions.',
  feature5Badge: 'Analytics',
  feature6Title: 'Custom Branding',
  feature6Description:
    'Add your logo, colors, and branding to invoices and client communications to maintain a professional image.',
  feature6Badge: 'Branding',
  feature7Title: 'Payment Gateway Integration',
  feature7Description:
    'Accept payments faster with integrated Stripe, PayPal, and bank transfer options directly from your invoices.',
  feature7Badge: 'Payments',
  feature8Title: 'Dedicated Support',
  feature8Description:
    'Get help when you need it with our responsive support team and comprehensive knowledge base for freelancers.',
  feature8Badge: 'Support',
  feature9Title: 'Data Privacy & Backup',
  feature9Description:
    'Your business data is automatically backed up daily and never shared with third parties - complete privacy guaranteed.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to simplify your freelance finances?',
