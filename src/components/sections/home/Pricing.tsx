...
const DEFAULT_PRICING = {
  ...
  mainTitleHighlight: 'Every Freelancer',
  mainDescription:
    'Start free and scale as you grow. No hidden fees, no long-term contracts. Perfect for freelancers who want to focus on their work, not their finances.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 25%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for new freelancers getting started',
  plan1Price: 'Free',
  plan1CTA: 'Start Free',
  plan1CTAHref: '/',
  plan2Name: 'Professional',
  plan2Description: 'For established freelancers with growing client base',
  plan2Price: '$19',
  plan2Period: '/month',
  ...
  plan3Name: 'Business',
  plan3Description: 'For agencies and teams managing multiple clients',
  plan3Price: '$49',
  plan3Badge: 'Best Value',
  plan3CTA: 'Start Free Trial',
  plan3CTAHref: '/',
  bottomTitle: 'Need a custom solution?',
  bottomDescription:
    'Managing multiple businesses or need advanced features? We offer custom plans tailored to your specific invoicing and accounting needs.',
  bottomCTA: 'Contact Sales',
  bottomCTAHref: '/',
} as const;
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <CardContent className="relative space-y-6">
                ...
                <Button
                  className={cn(
                    'w-full text-base py-6 transition-all',
                    plan.popular
