...
const DEFAULT_FOOTER = {
  logoText: 'Freelance Financials',
  companyDescription:
    'Empowering freelancers and consultants with professional financial management tools. Track expenses, manage invoices, and optimize your tax strategy with confidence.',
  contactEmail: 'support@freelancefinancials.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Financial District, Suite 200, New York, NY 10004',
  newsletterTitle: 'Financial Tips & Updates',
  newsletterPlaceholder: 'Enter your email for tax tips',
  newsletterDisclaimer:
    'Get weekly financial tips, tax updates, and freelance insights. Unsubscribe anytime.',
  section1Title: 'Features',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Freelance Financials. All rights reserved.',
  madeWithText: 'by financial experts',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com/freelancefinancials',
  social2Href: 'https://facebook.com/freelancefinancials',
  social3Href: 'https://instagram.com/freelancefinancials',
  social4Href: 'https://linkedin.com/company/freelancefinancials',
  social5Href: 'https://github.com/freelancefinancials',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
      ...
      links: [
        {
          ...
          editableId: 'link-footer-expenses',
        },
        {
          name: 'Invoice Management',
          href: '/features/invoicing',
          editableId: 'link-footer-invoicing',
        },
        {
          name: 'Tax Optimization',
          href: '/features/tax-tools',
          editableId: 'link-footer-tax-tools',
        },
        { name: 'Financial Reports', href: '/features/reports', editableId: 'link-footer-reports' },
        { name: 'Bank Integration', href: '/features/banking', editableId: 'link-footer-banking' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Financial Blog', href: '/blog', editableId: 'link-footer-blog' },
        { name: 'Careers', href: '/careers', editableId: 'link-footer-careers' },
        { name: 'Press Kit', href: '/press', editableId: 'link-footer-press' },
        { name: 'CPA Partners', href: '/partners', editableId: 'link-footer-partners' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Tax Guide', href: '/tax-guide', editableId: 'link-footer-tax-guide' },
        { name: 'Freelancer Community', href: '/community', editableId: 'link-footer-community' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Financial Compliance', href: '/compliance', editableId: 'link-footer-compliance' },
      ],
    },
  ];
  ...
  const bottomLinks = [
    ...
    { name: 'Financial Support', href: '/support', editableId: 'link-footer-support' },
  ];
